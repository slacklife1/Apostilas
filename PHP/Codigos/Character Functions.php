//**************************************
    ...
    // Description:Functions like isalpha(),
    //     isdigit(), etc.These functions expect a 
    //     character, such as 'a', or '?', not an i
    //     nteger. If you want to use integers, fir
    //     st convert the integer using the chr() f
    //     unction.Ported from ctype.h. by John
